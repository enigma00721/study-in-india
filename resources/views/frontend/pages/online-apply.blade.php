                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required type="number" name="mobile_number" class="form-control" placeholder="Mobile Number">
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required type="email" name="email" class="form-control" placeholder="Email Adress">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name">Address</label>
                                <input required type="text" class="form-control" name="address" placeholder="Address" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="district">District</label>
                                <input required type="text" class="form-control" name="district" placeholder="District" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required type="text" name="parent_name" placeholder="Parent Name" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required type="text" name="parent_address" placeholder="Parent Address" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="parent_contact">Parent Contact</label>
                                <input required type="number" name="parent_contact" placeholder="Parent Contact" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="parent_occupation">Parent Occupation</label>
                                <input required type="text" class="form-control" name="parent_occupation"
