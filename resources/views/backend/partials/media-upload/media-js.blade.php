    ...
    ;(function ($) {
        ...
        $(document).on('click','.media_upload_modal_submit_btn',function (e) {
            ...
            if( typeof allData != 'undefined'){
                mainUploadBtn.prev('input').val(allData.imgid);
                mainUploadBtn.prev('input').attr('data-imgsrc',allData.imgsrc);
                mainUploadBtn.parent().find('.img-wrap').html('<div class="attachment-preview"><div class="thumbnail"><div class="centered"><img src="'+allData.imgsrc+'"></div></div></div>');
            }
        ...
        function selectOldImage(){
            ...
            $('.media-uploader-image-list li[data-imgid="'+imageId+'"]').addClass('selected').siblings().removeClass('selected');
            $('.media-uploader-image-list li.selected').trigger('click');
        }
    })(jQuery);
</script>