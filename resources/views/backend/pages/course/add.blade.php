                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control"  id="fee" name="fee" value="{{old('fee')}}" placeholder="{{__('Fee')}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="seats">{{__('Seats')}}</label>
                                        <input type="number" class="form-control"  id="seats" name="seats" value="{{old('seats')}}" placeholder="{{__('Seats')}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="course_duration">{{__('Course Duration')}}</label>
                                        <input type="text" class="form-control"  id="course_duration" name="course_duration" value="{{old('course_duration')}}" placeholder="{{__('Course Duration')}}">
                                    </div>

                                    <div class="form-group">
                                        <label for="description">{{__('Description')}}</label>
                                        <textarea name="description" id="description" class="form-control" cols="30" placeholder="{{__('Description')}}" rows="10">{{old('description')}}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="elligibility" id="elligibility" class="form-control" cols="30" placeholder="{{__('Elligibility')}}" rows="10">{{old('elligibility')}}</textarea>
                                        <small class="info-text">{{__('separate responsibility by pipe (|), to break in new line')}}</small>
                                    </div>
