    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__('All Disciplines')}}</h4>
                        ...
                        <div class="tab-content margin-top-40" id="myTabContent">
                            @php $b=0; @endphp
                            @foreach($all_disciplines as $key => $discipline)
                                        ...
                                        @foreach($discipline as $data)
                                            <tr>
                                                ...
                                                <td style="display: flex;">
                                                    <form action='{{route('admin.discipline.delete',$data->id)}}' method="POST" >
                                                        @csrf
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Add New Discipline</h4>
    ...
    <div class="modal fade" id="category_edit_modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('admin.discipline.update')}}"  method="post">
...
@section('script')
    ...
    $(document).ready(function(){
        ...
        $('.delete-confirm').on('click', function (event) {
          ...
          swal({
              title: 'Are you sure?',
              text: 'All Courses associated with this discipline will be deleted too!',
              icon: 'warning',
              buttons: ["Cancel", "Yes!"],
          }).then(function(value) {
              if (value) {
