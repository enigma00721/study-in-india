                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name"
                                            value="{{ $university->name }}" placeholder="{{ __('Name') }}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="description" value='{{ $university->description }}'>
                                        <div class="summernote" data-content='{{ $university->description }}'></div>
                                    </div>


                                    <div class="form-group">
                                        <label>{{ __('Facilities') }}</label>
                                        <input type="hidden" name="facilities" value=" {{ $university->facilities }} ">
                                        <div class="summernote" data-content="{{ $university->facilities }}"></div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="location" name="location"
                                            value="{{ $university->location }}" placeholder="{{ __('Location') }}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control">
                                            <option @if ($university->status == 'publish') selected @endif value="publish">
                                                {{ __('Publish') }}
                                            </option>
                                            <option @if ($university->status == 'draft') selected @endif value="draft">{{ __('Draft') }}
                                            </option>
                                        </select>
                                    </div>
                                    <button type="submit"
                                        class="btn btn-primary mt-4 pr-4 pl-4">{{ __('Update University') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
