                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="facilities" id="facilities" class="form-control" cols="30" placeholder="{{__('Facilities')}}" rows="10">{{old('facilities')}}</textarea>
                                        <small class="info-text">{{__('separate responsibility by pipe (|), to break in new line')}}</small>
                                    </div>
                                    {{-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  id="location" name="location" value="{{old('location')}}" placeholder="{{__('Location')}}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="media-upload-btn-wrapper">
                                            ...
                                            <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="Select University Image" data-modaltitle="Upload University Image" data-toggle="modal" data-target="#media_upload_modal">
                                                {{__('Upload Image')}}
                                            </button>
                                        </div>
